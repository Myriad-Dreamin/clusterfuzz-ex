...
#   fs.copytree(
#       os.path.join(src_root_dir, 'src/local/native/patch/run_fuzz_bot.py'),
#       os.path.join(bot_src_dir, 'python/bot/startup/run_bot.py'))
...
def _setup_environment_and_configs(args, appengine_path):
  ...
  os.environ['COMMAND_OVERRIDE'] = f'fuzz libFuzzer {args.fuzz_job}'
